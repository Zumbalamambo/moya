...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        buttonImage3 = Image.open('Check.png').resize((80,80))
        self.buttonPhoto3 = ImageTk.PhotoImage(buttonImage3)
        ...
        def pub_capture():
            pub_capture_image = rospy.Publisher('/capture_image', String, queue_size=10)
            pub_capture_image.publish("")

        button13 = tk.Button(self,image=self.buttonPhoto3,compound='center',bg='white',bd = 0,
                            command=pub_capture)
        button13.grid(row=380, column = 100)
